...
if analyze_validation_set is True:
    ...
    evaluation_directory_val = project_folder + "val" + amount_data
    name_val_csv_file_1 = evaluate_and_predict(model, evaluation_directory_val, results_directory, 'val')
...
path_file_2 = name_val_csv_file_1
